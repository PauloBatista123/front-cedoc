import { Box, Button, Drawer, DrawerBody, DrawerCloseButton, DrawerContent, DrawerFooter, DrawerHeader, DrawerOverlay, FormErrorMessage, FormLabel, Stack, Text } from "@chakra-ui/react";
...
import { newFormDataImportarDossies, newFormDataNovoDocumento, validationSchemaImportarDossies, validationSchemaNovoDocumento } from "../../utils/schemas";
...
export function DialogAdd({isOpen, onClose}: DialogAddProps){
  ...
  const handleCreateDocument = (data: newFormDataImportarDossies) => {
    console.log(data);
  }
